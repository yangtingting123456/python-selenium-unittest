...
class HomePageTest(unittest.TestCase):
    ...
    def test_shopping_cart_empty_message(self):
        ...
        shopping_cart_status = self.driver.find_element_by_css_selector("p.empty").text.self.assertEqual("You have no items in your shopping cart.", "shopping_cart_status")
